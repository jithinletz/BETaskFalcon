...
namespace BETaskAPI.DAL
{
    ...
    public class ItemDAL
    {
        ...
        public List<Item> GetItemDetailsByCategoryDescription(string company, string location, string categoryName)
        {
            List<Item> lstItemDetails = new List<Item>();
            SqlServerDBConnectionLogic.SqlServerDBConnection(company, location);
            try
            {
                using (SqlCommand cmd = new SqlCommand("APP_GetItemDetailsByCategoryDescription", SqlServerDBConnectionLogic.Maincn))
                {
